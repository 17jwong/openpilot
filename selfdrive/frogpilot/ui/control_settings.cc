...
FrogPilotControlsPanel::FrogPilotControlsPanel(SettingsWindow *parent) : FrogPilotListWidget(parent) {
  ...
  for (const auto &[param, title, desc, icon] : controlToggles) {
    ...
    if (param == "AdjustablePersonalities") {
      ...
      QStringList models = {"los-angeles", "certified-herbalist", "duck-amigo", "north-dakota-v2", "notre-dame", "recertified-herbalist", "secret-good-openpilot"};
      QStringList modelLabels = {"Los Angeles (Default)", "Certified Herbalist", "Duck Amigo", "North Dakota V2", "Notre Dame", "Recertified Herbalist", "SecretGoodOpenpilot"};
